...
function Field({
  ...
  return (
    <div className="space-y-1.5">
      <label
        htmlFor={id}
        className="text-[10px] text-zinc-500 uppercase font-bold tracking-widest block"
      >
      ...
      <div className="relative">
        <input
          ...
          className="w-full bg-zinc-900 border border-zinc-800 rounded-xl px-4 py-3.5 text-sm text-white placeholder:text-zinc-700 focus:outline-none focus:border-teal-500/60 focus:ring-1 focus:ring-teal-500/20 transition-all pr-10"
        />
        {suffix && (
